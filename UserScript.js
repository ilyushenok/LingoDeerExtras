...
window.addEventListener('load', function() {
	...
	setInterval(function() {
		...
		if (app && !app.hasAttribute(extrasEnabledAtt)) {
			...
			settings.innerHTML = '<div class="lingodeer-extras"><div class="lingodeer-extras_inner"><div class="lingodeer-extras_title">LingoDeer Extras</div></div></div>';
